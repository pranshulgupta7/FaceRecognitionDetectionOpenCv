...
Original file is located at
    https://colab.research.google.com/drive/1H_E8wuV63hBnFIRVLvO2Pc8-eYUBffbT
"""
...
f_01 = np.load('./face_01.npy').reshape((20,(50*50*3))) # Pranshul
...
labels[:20, :] = 0.0 # first 20 for pranshul(0)
# labels[20:40, :] = 1.0
# labels[40:, :] = 2.0
...
def knn(x,train,targets,k=5):
  ...
  dist = []
  for ix in range(m):
    # calculate distance from all points and store in dist
